...
cp /home/ubuntu/key-sf /home/ubuntu/.ssh/key-sf.pub
cp /home/ubuntu/key-sf /home/ubuntu/.ssh/key-sf
mv /home/ubuntu/key-sf.pub /root/.ssh/key-sf.pub
mv /home/ubuntu/key-sf /root/.ssh/key-sf
echo "private_key_file = /home/ubuntu/.ssh/key-sf.pub" >> /etc/ansible/ansible.cfg
echo "private_key_file = /home/ubuntu/.ssh/key-sf.pub" >> /opt/kubernetes_setup/kubespray/ansible.cfg
chmod 700 /home/ubuntu/.ssh/
chmod 700 /root/.ssh/
chmod 600 /home/ubuntu/.ssh/key-sf
chown -R ubuntu:ubuntu /home/ubuntu/.ssh/key-sf
chmod 600 /root/.ssh/key-sf
chown -R root:root /root/.ssh/key-sf
chmod 644 /home/ubuntu/.ssh/key-sf.pub
chown -R ubuntu:ubuntu /home/ubuntu/.ssh/key-sf.pub
chmod 644 /root/.ssh/key-sf.pub
chown -R root:root /root/.ssh/key-sf.pub
